...
cookies = {
    ...
    '895bc47f19a19e246b54daafcf951e1a': '7mvk2vfluqouks6f5v7mcarhov',
    'joomla_remember_me_d7f12ac5c8ac53df36f3e40e8e7fcb86': 'giT44vuOO50tXTOB.QhmK5XFb4Rp2yEMZHMkt',
}
...
response = requests.post(
    'https://www.zipmec.eu/en/cards.html?_gl=1*ll0wjm*_up*MQ..*_ga*MTE2MjAwMTY4My4xNzI0ODQ2NjY3*_ga_J2JX61HXMW*MTcyNDg0NjY2Ni4xLjAuMTcyNDg0NjY2Ni4wLjAuMA..',
    cookies=cookies,
    headers=headers,
    data=data,
)

with open('cards_Nursery.html', 'w', encoding='utf-8') as file:
